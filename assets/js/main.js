  ...
  var doobJs = {
    ...
    contactForm: function () {
      $('.contact-form-1').on('submit', function (e) {
        ...
        const messageBody = `Full Name: ${name.value} <br> Email: ${email.value} <br> Phone: ${phone.value} <br> Subject: ${subject.value} <br> Message: ${message.value}`;

        Email.send({
          Host: 'smtp.elasticemail.com',
          Username: 'prsthibha@gmail.com',
          Password: 'B959E2D7D87693EF8584943EF584346B2B04',
          To: 'prsthibha@gmail.com',
          From: 'prsthibha@gmail.com',
